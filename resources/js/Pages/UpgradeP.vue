...
<template>
  <Head title="Upgrade" />
  <SectionHead text="Upgrade Dashboard" />

  <div class="bg-white rounded-md p-5 mb-5">
    Request a Package Upgrade<br /><br />
    ...
    >
      <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <!-- Modal body -->
          <form class="p-4 md:p-5" @sumbit.prevent="onSubmit" onSubmit="return false;">
            <div class="grid gap-4 mb-4 grid-cols-2">
              <div class="col-span-2 sm:col-span-2">
                ...
                >
                  ...
                  <option value="CA">Contractor</option>
                  <option value="FR">Platinum</option>
                  <option value="DE">Diamond</option>
                </select>
              </div>
