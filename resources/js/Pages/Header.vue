<template>
  ...
  >
    ...
    <template #left>
      <AppSidebar :minimized="isSidebarMinimized" :animated="!isMobile" :mobile="isMobile" class="w-0"  />
    </template>
    ...
    <template #content>
      ...
      <main class="p-4 pt-0 container mx-auto">
        <article>
          <!-- <RouterView /> -->
          <div class="p-3"></div>
          <div class="grid grid-cols-3 gap-3">
            <div class="bg-blue-100 rounded-lg p-10"></div>
            <div class="bg-blue-100 rounded-lg p-10"></div>
            <div class="bg-blue-100 rounded-lg p-10"></div>
          </div>
        </article>
