...
<template>
  <Head title="Beneficiary Document" />
  <SectionHead text="Beneficiary Document" />
      ...
      <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        >
          ...
          <div class="relative">
            ...
            <button
              data-modal-target="beneficiary-modal"
              data-modal-toggle="beneficiary-modal"
        ...
        >
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-6 py-4">Beneficiary Document</td>
              <td class="px-6 py-4">
                <span
