...
const allotmentFormSubmit = () => {
  allotmentForm.post('route("documents")');
};
</script>

<template>
  <Head title="Allotment Document" />
  <SectionHead text="Allotment Document" />
      ...
      <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        >
          ...
          <div class="relative">
            ...
            <button
              data-modal-target="allotment-modal"
              data-modal-toggle="allotment-modal"
          ...
          <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <form
                ...
                @sumbit.prevent="allotmentFormSubmit"
              >
        ...
        >
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-6 py-4">Allotment Form</td>
              <td class="px-6 py-4">
                <span
