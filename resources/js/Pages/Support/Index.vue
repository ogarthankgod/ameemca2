...
<template>
    ...
    <section class="flex-col w-full mb-6">
        ...
        >
            ...
            <!-- Categories -->
            <div
                class="bg-white rounded-lg shadow-sm sm:space-x-0 h-fit max-h-fit"
            >
                <div
        ...
        <section class="mt-7 sm:grid sm:grid-cols-12 gap-2 mb-7">
            <div
                class="bg-white shadow-md rounded-md sm:col-span-3 p-5 h-fit max-h-fit"
            >
                ...
                >
                    ...
                    >
                        ...
                        <div class="">
                            <p>
                                <span
                                    class="text-slate-400 text-sm mb-1 capitalize"
                                >
