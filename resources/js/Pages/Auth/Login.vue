      ...
      >
        <div class="max-w-xl lg:max-w-3xl">
          <div class="relative -mt-16 block lg:hidden">
            ...
            >
              <span class="sr-only">Home</span>
              <img :src="AmeemcaLogoPng" class="w-20 h-20 fill-current text-gray-500" />
            </Link>
            ...
            <p class="mt-4 leading-relaxed text-red-600">
              "Login Using Maintenance Account!"...
            </p>
          </div>
          ...
          <form class="mt-8" @submit.prevent="submit">
            ...
            <div class="mt-3 col-span-6">
              <p class="mt-4 text-sm text-gray-500 sm:mt-0">
                Not registered?
                <Link :href="route('register')" class="text-blue-700 underline"
                  >Create Account</Link
                >.
              </p>
            </div>
