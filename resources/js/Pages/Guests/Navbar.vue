...
const GuestItems = [
    { title: "Home", icon: "dashboard", route: "guest", id: 1 },
    { title: "Team", icon: "dashboard", route: "team", id: 2 },
    // { title: "Vision", icon: "dashboard", route: "vision", id: 3 },
    { title: "Membership", icon: "dashboard", route: "membership", id: 4 },
    { title: "FAQ", icon: "dashboard", route: "faq", id: 5 },
    { title: "Contact Us", icon: "dashboard", route: "contact", id: 6 },
];
</script>
    ...
    >
        ...
        >
            ...
            >
                <Logo/>
                <span
                    class="hidden self-center text-2xl font-semibold whitespace-nowrap dark:text-white"
                    >Ameemca</span
                >
            </Link>
            ...
            >
                ...
                >
                    <li v-for="item in GuestItems" :key="item.id">
                        <Link
                            :href="route(item.route+`.index`)"
                            :class="
                                route().current() == item.route+`.index`
